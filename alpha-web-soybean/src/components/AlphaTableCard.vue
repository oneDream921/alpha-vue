...
<template>
  <section class="alpha-table-card" v-bind="attrs">
    ...
    <ASpin :spinning="loading" class="alpha-table-card-spin">
...
.alpha-table-card {
  ...
  box-shadow: 0 1px 2px color-mix(in srgb, rgb(var(--base-text-color)) 6%, transparent);
}
...
.alpha-table-card-table .ant-table-thead > tr > th {
  background: color-mix(in srgb, var(--alpha-surface) 94%, var(--alpha-text-primary));
