---
name: afk-project-soybean-frontend
description: Apply and review the Alpha Vue SoybeanJS frontend standard for Vue
  3, strict TypeScript, Ant Design Vue, Elegant Router, Pinia, UnoCSS, theme
  tokens, shared components, responsive admin pages, ECharts, permissions, and
  browser-based visual verification. Use for any implementation, refactor, code
  review, debugging, visual polish, route integration, component extraction, or
  pre-delivery validation under alpha-web-soybean.
---
