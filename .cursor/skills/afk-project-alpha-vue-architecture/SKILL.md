---
name: afk-project-alpha-vue-architecture
description: Design or review Alpha Vue system boundaries, module ownership,
  technology choices, significant non-functional requirements, and architecture
  changes. Use for architecture design, module split or merge decisions,
  cross-layer design, technical trade-offs, scalability or operational
  decisions, and ADR discussions in this Vue 3 and Spring Boot project.
---
