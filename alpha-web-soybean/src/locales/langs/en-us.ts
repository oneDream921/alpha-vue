const local: App.I18n.Schema = {
  ...
  route: {
    ...
    system_depts: 'Department Management',
    system_settings: 'System Settings',
    system_dicts: 'Data Dictionary',
    monitor_redis: 'Redis Management',
    monitor_sql: 'SQL Logs',
    'monitor_online-users': 'Online Users',
    document: 'Document',
