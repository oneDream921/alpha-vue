    ...
    >
        <div class="avatar-cropper-layout">
            <div class="avatar-cropper-canvas">
                ...
                />
                <div v-else class="avatar-cropper-empty">
                    请选择一张头像图片
                </div>
            </div>
        ...
        <div class="avatar-cropper-toolbar">
            <input
                ...
                @change="onFileChange"
            />
            <a-button @click="selectImage"><UploadOutlined />选择图片</a-button>
            <a-button :disabled="!source" @click="cropper?.changeScale(1)"
                ><PlusOutlined
            /></a-button>
            <a-button :disabled="!source" @click="cropper?.changeScale(-1)"
                ><MinusOutlined
            /></a-button>
            <a-button :disabled="!source" @click="cropper?.rotateLeft()"
                ><RotateLeftOutlined
            /></a-button>
            <a-button :disabled="!source" @click="cropper?.rotateRight()"
                ><RotateRightOutlined
            /></a-button>
            <span class="avatar-cropper-toolbar-spacer" />
            <a-button @click="close">取消</a-button>
            <a-button type="primary" :disabled="!source" @click="exportImage"
                >确定上传</a-button
            >
        </div>
    </a-modal>
