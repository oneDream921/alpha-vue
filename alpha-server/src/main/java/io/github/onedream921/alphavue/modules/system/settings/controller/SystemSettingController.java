...
public class SystemSettingController extends BaseController {
    ...
    public SystemSettingController(SystemSettingService service, SystemAccessService access, OfficialAccountService officialAccountService, FileService fileService) { this.service = service; this.access = access; this.officialAccountService = officialAccountService; this.fileService = fileService; }
    ...
    public ApiResponse<FileService.StorageTestResult> testFileStorage(HttpServletRequest request) {
        access.require("system:setting:update");
        return success(fileService.testStorage(), request);
    }
