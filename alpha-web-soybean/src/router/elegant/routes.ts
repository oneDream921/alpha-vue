...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    name: 'files',
    path: '/files',
    component: 'layout.base$view.files',
    meta: {
      title: 'files',
      i18nKey: 'route.files'
    }
    ...
    children: [
      {
        ...
        component: 'view.monitor_online-users',
        meta: {
          title: 'monitor_online-users',
          i18nKey: 'route.monitor_online-users'
        }
      },
      {
        name: 'monitor_redis',
        path: '/monitor/redis',
        component: 'view.monitor_redis',
        meta: {
          title: 'monitor_redis',
          i18nKey: 'route.monitor_redis'
        }
      },
      {
        name: 'monitor_sql',
        path: '/monitor/sql',
        component: 'view.monitor_sql',
        meta: {
          title: 'monitor_sql',
          i18nKey: 'route.monitor_sql'
        }
      }
    ]
  },
    ...
    children: [
      {
        name: 'system_depts',
        path: '/system/depts',
        component: 'view.system_depts',
        meta: {
          title: 'system_depts',
          i18nKey: 'route.system_depts'
        }
      },
      {
        name: 'system_dicts',
        path: '/system/dicts',
        component: 'view.system_dicts',
        meta: {
          title: 'system_dicts',
          i18nKey: 'route.system_dicts'
        }
      },
      {
        name: 'system_menus',
